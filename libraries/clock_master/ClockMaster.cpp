...
void ClockMaster::set_divider(char* data)
{
  ...
  switch(tmp.get_channel())
  {
     case 0:
     	...
     	DEBUG_RC_PRINTLN("***************************************************");
   	DEBUG_RC_PRINTLN("Set pps divider 0 parameters");
   	break;
     case 1:
     	divider_1=tmp;
     	divider_1.set_parameters();
   	DEBUG_RC_PRINTLN("***************************************************");
   	DEBUG_RC_PRINTLN("Set pps divider 1 parameters");
   	break;    
     case 2:
     	divider_2=tmp;
     	divider_2.set_parameters();
   	DEBUG_RC_PRINTLN("***************************************************");
   	DEBUG_RC_PRINTLN("Set pps divider 2 parameters");
     	break;
     case 3:
     	divider_3=tmp;
     	divider_3.set_parameters();
   	DEBUG_RC_PRINTLN("***************************************************");
   	DEBUG_RC_PRINTLN("Set pps divider 3 parameters");
     	break;
  }
...
void ClockMaster::get_divider_parameters(int channel)
{
  switch(channel)
  {
   case 0: 
   	...
   	DEBUG_RC_PRINTLN("***************************************************");
   	DEBUG_RC_PRINTLN("Get pps divider 0 parameters");
    break;

   case 1: 
   	divider_1.get_channel();
   	DEBUG_RC_PRINTLN("***************************************************");
   	DEBUG_RC_PRINTLN("Get pps divider 1 parameters");
    break;

   case 2: 
   	divider_2.get_channel();
   	DEBUG_RC_PRINTLN("***************************************************");
   	DEBUG_RC_PRINTLN("Get pps divider 2 parameters");
    break;

   case 3: 
   	divider_3.get_channel();
   	DEBUG_RC_PRINTLN("***************************************************");
   	DEBUG_RC_PRINTLN("Get pps divider 3 parameters");
    break;
  }
}
...
String ClockMaster::reset()
{
  ...
  //noInterrupts();
  DEBUG_RC_PRINTLN("***************************************************");
  DEBUG_RC_PRINTLN("Clock Master reset method:");
